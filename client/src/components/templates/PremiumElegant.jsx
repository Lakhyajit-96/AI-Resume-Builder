...
const PremiumElegant = ({ data = {}, accentColor = '#3B82F6' }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white text-gray-800 leading-relaxed">
      ...
      <header className="text-center mb-8 pb-6 border-b-2" style={{ borderColor: accentColor }}>
        <h1 className="text-3xl font-semibold mb-2" style={{ color: accentColor }}>
        ...
        <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600 mt-3">
          ...
          {data.personal_info?.linkedin && (
            <a target="_blank" rel="noreferrer" href={data.personal_info?.linkedin} className="flex items-center gap-1">
              <Linkedin className="size-4" />
              <span className="break-all">{data.personal_info.linkedin}</span>
            </a>
          )}
          {data.personal_info?.website && (
            <a target="_blank" rel="noreferrer" href={data.personal_info?.website} className="flex items-center gap-1">
          ...
          <section className="mb-6">
            ...
            <div className="space-y-3">
              {data.project.map((proj, idx) => (
                <div key={idx} className="flex justify-between items-start border-l-3 border-gray-300 pl-6">
                  <div>
