    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex gap-2">
                <input value={newSkill} onChange={(e)=> setNewSkill(e.target.value)} onKeyDown={handleKeyPress} type="text" placeholder="Enter a skill(e.g.,JavaScript, Project Mangement)" className="flex-1 px-3 py-2 text-sm" />
