            ...
            <div className="min-h-screen pb-20">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <div className="flex items-center gap-4 ">
                        ...
                        <Link to='/app' className="flex items-center gap-2 border border-slate-400 hover:bg-green-50 transition rounded-full px-7 h-12 text-slate-700">
                    ...
                    {/* Marquee logos */}
                    <div className="marquee-container relative overflow-hidden w-full py-4">
                        <div className="marquee-inner flex items-center gap-10">
                            {[...logos, ...logos].map((logo, index) => (
                                <img
                                    key={index}
                                    src={logo}
                                    alt="logo"
                                    className="h-6 w-auto opacity-90 hover:opacity-100 transition-transform duration-200 hover:scale-110"
                                />
                            ))}
                        </div>
                    </div>
