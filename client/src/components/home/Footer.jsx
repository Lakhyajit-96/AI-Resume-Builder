                ...
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><Link to="/affiliate" className="hover:text-green-600 transition">Affiliate</Link></li>
                        </ul>
                    </div>
                    <div>
                        <p className="text-slate-800 font-semibold">Resources</p>
                        <ul className="mt-2 space-y-2">
                            <li><Link to="/company" className="hover:text-green-600 transition">Company</Link></li>
                            <li><Link to="/blogs" className="hover:text-green-600 transition">Blogs</Link></li>
                            <li><Link to="/community" className="hover:text-green-600 transition">Community</Link></li>
                            <li><Link to="/careers" className="hover:text-green-600 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></Link></li>
