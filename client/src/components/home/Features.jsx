                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">AI-Powered Resume Writing</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Automatically generate professional, ATS-optimized resumes in seconds using advanced AI trained on top hiring patterns.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Smart Personalization</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Tailor your resume to any job description instantly - resume. adapts your wording, tone, and keywords to match recruiter expectations.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                        <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-base font-semibold text-slate-700">Save & Export Easily</h3>
                                <p className="text-sm text-slate-600 max-w-xs">Store your resumes securely in the cloud and export them as polished PDFs with one click.</p>
                            </div>
                        </div>
                    </div>
                </div>
